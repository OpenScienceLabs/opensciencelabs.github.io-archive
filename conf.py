...
BLOG_AUTHOR = "Open Science Labs Team"  # (translatable)
BLOG_TITLE = "Open Science Labs"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://opensciencelabs.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://opensciencelabs.org/"
BLOG_EMAIL = "opensciencelabs@gmail.com"
# (translatable)
BLOG_DESCRIPTION = "Open Science Labs"
...
THEME_CONFIG = {
    DEFAULT_LANG: {
        # Show either light or dark versions of the page
        'navbar_light': False,
...
POSTS = (
    ("pages/blog/*.markdown", "blog", "post_ipynb.tmpl"),
    ("pages/blog/*.md", "blog", "post_ipynb.tmpl"),
    ("pages/blog/*.html", "blog", "post.tmpl"),
    ("pages/blog/*.ipynb", "blog", "post_ipynb.tmpl"),
)
PAGES = (
    ("pages/*.md", "", "page.tmpl"),
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="/team">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
...
# is in the manual.
# COMMENT_SYSTEM_ID = "opensciencelabs.org/opensciencelabs.org"
...
TWITTER_CARD = {
    ...
    'site': '@opensciencelabs',         # twitter nick for the website
